...
export default function Card(props: any) {
    return (
        <>
            {
                props.noData ? (
                    <div className="group relative cursor-wait flex-grow bg-white h-80 rounded-xl animate-pulse mr-12 last:mr-0">
                    </div >
                ) : (
                    <div className="group relative hover:scale-[1.05] ease-in-out duration-75 cursor-pointer bg-white p-4 rounded-xl">
                        <div className="w-full relative overflow-hidden rounded-md lg:aspect-none group-hover:opacity-75 aspect-square">
